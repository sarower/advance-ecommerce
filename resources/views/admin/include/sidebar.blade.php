            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('home')}}">
                        ...
                        <span class="side-menu__label">e-trade</span>
                    </a>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('unit.create')}}" class="slide-item">Brand Add</a></li>
                        <li><a href="{{route('unit.index')}}" class="slide-item">Brand Manage</a></li>
                    </ul>
                </li>
