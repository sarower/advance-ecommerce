                                ...
                                <div class="slider-activation-one axil-slick-dots">
                                    <div class="single-slide slick-slide">
                                        ...
                                        <div class="main-slider-thumb">
                                            <img src="{{ asset('frontEnd/assets') }}/images/product/product-40.png"
                                                alt="Product">
                                        </div>
                                    </div>
                                    <div class="single-slide slick-slide">
                                        ...
                                        <div class="main-slider-thumb">
                                            <img src="{{ asset('frontEnd/assets') }}/images/product/product-46.png"
                                                alt="Product">
                                        </div>
                                    </div>
                                    <div class="single-slide slick-slide">
                            ...
                            <div class="slider-product-box">
                                <div class="product-thumb">
                                    <a href="single-product.html">
                                        <img src="{{ asset('frontEnd/assets') }}/images/product/product-41.png"
                                            alt="Product">
                                    </a>
                                </div>
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                            src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-1.png"
                                            alt="Product Images">
                                        <img class="hover-img"
                                            src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-4.png"
                                            alt="Product Images">
                                    </a>
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500"
                                            src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-2.png"
                                            alt="Product Images">
                                        <img class="hover-img"
                                            src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-6.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="300" data-sal-duration="1500"
                                            src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-3.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-four">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                            src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-5.png"
                                            alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-16.png"
                                        alt="Product Images">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-seven">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-17.png"
                                        alt="Product Images">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-seven">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-18.png"
                                        alt="Product Images">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-seven">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-19.png"
                                        alt="Product Images">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-seven">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-20.png"
                                        alt="Product Images">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-seven">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-21.png"
                                        alt="Product Images">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-seven">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-22.png"
                                        alt="Product Images">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-seven">
                            ...
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="800" loading="lazy"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-23.png"
                                        alt="Product Images">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-6">
                            <div class="poster-countdown-thumbnail">
                                <img src="{{ asset('frontEnd/assets') }}/images/product/poster/poster-05.png"
                                    alt="Poster Product">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                                src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-8.png"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500"
                                                src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-7.png"
                                                alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                        ...
                        <div class="row row--15">
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-8.png"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-7.png"
                                                alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-6.png"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-5.png"
                                                alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-4.png"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-3.png"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-2.png"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-1.png"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-two has-color-pick">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-14.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-two has-color-pick">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-15.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">15% OFF</div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-two has-color-pick">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-10.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-two has-color-pick">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-11.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-two has-color-pick">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="fade" data-sal-delay="300" data-sal-duration="1500"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-12.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">15% OFF</div>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product product-style-two has-color-pick">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img data-sal="fade" data-sal-delay="400" data-sal-duration="1500"
                                        src="{{ asset('frontEnd/assets') }}/images/product/fashion/product-13.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">30% OFF</div>
