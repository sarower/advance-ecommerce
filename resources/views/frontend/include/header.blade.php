            ...
            <div class="header-navbar">
                <div class="header-nav-department">
                    <aside class="header-department">
                        <button class="header-department-text department-title" id="openCategory">
                            <span class="icon"><i class="fal fa-bars"></i></span>
                            <span class="text">Categories</span>
                        </button>
                        <nav class="department-nav-menu" id="closeCategory">
                            ...
                            <ul class="nav-menu-list">
                                            ...
                                            <div class="featured-product">
                                                ...
                                                <div class="product-list">
                                                    <div class="item-product">
                                                        <a href="#"><img
                                                                src="{{ asset('frontEnd/assets') }}/images/product/product-feature1.png"
                                                                alt="Featured Product"></a>
                                                    </div>
                                                    <div class="item-product">
                                                        <a href="#"><img
                                                                src="{{ asset('frontEnd/assets') }}/images/product/product-feature2.png"
                                                                alt="Featured Product"></a>
                                                    </div>
                                                    <div class="item-product">
                                                        <a href="#"><img
                                                                src="{{ asset('frontEnd/assets') }}/images/product/product-feature3.png"
                                                                alt="Featured Product"></a>
                                                    </div>
                                                    <div class="item-product">
                                                        <a href="#"><img
                                                                src="{{ asset('frontEnd/assets') }}/images/product/product-feature4.png"
                                                                alt="Featured Product"></a>
                                                    </div>
                                                </div>
                                ...
                                <li>
                                    <a href="#" class="nav-link has-megamenu">
                                        <span class="menu-icon"><img
                                                src="{{ asset('frontEnd/assets') }}/images/product/categories/cat-02.png"
                                                alt="Department"></span>
                                ...
                                <li>
                                    <a href="#" class="nav-link has-megamenu">
                                        <span class="menu-icon"><img
                                                src="{{ asset('frontEnd/assets') }}/images/product/categories/cat-03.png"
                                                alt="Department"></span>
                                ...
                                <li>
                                    <a href="#" class="nav-link">
                                        <span class="menu-icon"><img
                                                src="{{ asset('frontEnd/assets') }}/images/product/categories/cat-04.png"
                                                alt="Department"></span>
                                ...
                                <li>
                                    <a href="#" class="nav-link">
                                        <span class="menu-icon"><img
                                                src="{{ asset('frontEnd/assets') }}/images/product/categories/cat-05.png"
                                                alt="Department"></span>
                                ...
                                <li>
                                    <a href="#" class="nav-link">
                                        <span class="menu-icon"><img
                                                src="{{ asset('frontEnd/assets') }}/images/product/categories/cat-06.png"
                                                alt="Department"></span>
                                ...
                                <li>
                                    <a href="#" class="nav-link">
                                        <span class="menu-icon"><img
                                                src="{{ asset('frontEnd/assets') }}/images/product/categories/cat-07.png"
                                                alt="Department"></span>
                                ...
                                <li>
                                    <a href="#" class="nav-link">
                                        <span class="menu-icon"><img
                                                src="{{ asset('frontEnd/assets') }}/images/product/categories/cat-08.png"
                                                alt="Department"></span>
                        ...
                        <li class="my-account">
                            ...
                            <div class="my-account-dropdown">
                                ...
                                <div class="reg-footer text-center">No account yet? <a
                                        href="{{ route('user.register') }}" class="btn-link">REGISTER HERE.</a></div>
                            </div>
                        </li>
